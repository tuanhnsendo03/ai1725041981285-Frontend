          ...
          <div className="mx-auto max-w-2xl lg:max-w-none">
            <div className="text-center">
              <h2 className="text-3xl font-bold tracking-tight text-ai-title-regular sm:text-4xl">
                Drive Your Dreams with Reliable Car Rentals
              </h2>
              <p className="mt-4 text-lg leading-8 text-ai-subtext-regular">
                Experience the freedom of hassle-free vehicle rentals for all your travel needs, whether for business or leisure. Book now and hit the road with confidence.
              </p>
            </div>
